...
* ```bash
  apt-get update -y && apt-get upgrade -y && pkg install git -y && git clone https://github.com/TechnoIndian/Apktool && cd Apktool-termux && chmod +x * && bash setup.sh && bash apktool.sh
```
